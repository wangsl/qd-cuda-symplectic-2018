...
function main() 
{
    ...
    export OPTIMIZATION_FLAGS_FOR_INTEL_FORTRAN_COMPILERS="-132 -r8 -fPIC -unroll -ip -axCORE-AVX2 -qopenmp -qopt-report-stdout -qopt-report-phase=openmp -fp-model strict"
