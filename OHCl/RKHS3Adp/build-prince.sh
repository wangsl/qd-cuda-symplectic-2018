...
function main() 
{
    ...
    export OPTIMIZATION_FLAGS_FOR_INTEL_COMPILERS="-fPIC -unroll -ip -axCORE-AVX2 -qopenmp -qopt-report-stdout -qopt-report-phase=openmp -fp-model strict"
    
    export OPTIMIZATION_FLAGS_FOR_INTEL_FORTRAN_COMPILERS="-fPIC -unroll -ip -axCORE-AVX2 -qopenmp -qopt-report-stdout -qopt-report-phase=openmp -fp-model strict"
	...
	case $arg in
	    ...
	    make)
		export PATH=.:$MY_INTEL_PATH:$NVCC_PATH:$PATH
		echo " Run make"
		eval "$args"
		exit
		;;
